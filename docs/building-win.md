...
The default modern toolset from Visual Studio 2026 (`v145`) does not support Windows 7, so for YoriGram Desktop you must use `-vcvars_ver=14.44` (`v144.4`, based on `v143` with Windows 7 support).
...
In the initialized terminal, go to ***BuildPath*** and run
    ...
    git clone --recursive https://github.com/harshi79/YoriGram.git tdesktop
...
* The result YoriGram.exe will be located in **D:\TBuild\tdesktop\out\Debug** (and **Release**)

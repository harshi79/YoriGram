...
const QString &readAutoupdatePrefixRaw() {
	...
	return AutoupdatePrefix("https://github.com/harshi79/YoriGram/releases/latest/download/");
}
...
void writeAutoupdatePrefix(const QString &prefix) {
    ...
    const auto fixedPrefix = QString::fromStdString("https://github.com/harshi79/YoriGram/releases/latest/download/");

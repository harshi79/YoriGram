...
#ifdef OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"YoriGram.YoriGramDesktop.Store";
#else // OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"YoriGram.YoriGramDesktop";
#endif // OS_WIN_STORE
...
void CleanupShortcut() {
	...
	QString path = systemShortcutPath() + u"YoriGram.lnk"_q;
...
bool checkInstalled(QString path = {}) {
	...
	const auto installed = u"YoriGram Desktop/YoriGram.lnk"_q;
	const auto old = u"YoriGram for Windows/YoriGram.lnk"_q;

...
if %Build64% neq 0 (
  ...
  set "SetupFile=yorigram-setup-x64.%AppVersionStrFull%.exe"
  ...
  set "SetupFile=yorigram-setup-arm64.%AppVersionStrFull%.exe"
  ...
  set "SetupFile=yorigram-setup.%AppVersionStrFull%.exe"
...
if %Build64% neq 0 (
  ...
  set "FinalDeployPath=%FinalReleasePath%\%AppVersionStrMajor%\%AppVersionStrFull%\yorigram"
)

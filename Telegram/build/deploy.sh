...
MacSetupFile="yorigram-setup.$AppVersionStrFull.dmg"
MacRemoteFolder="tmac"
WinDeployPath="$BackupPath/$AppVersionStrMajor/$AppVersionStrFull/yorigram"
WinUpdateFile="tupdate$AppVersion"
WinSetupFile="yorigram-setup.$AppVersionStrFull.exe"
WinPortableFile="tportable.$AppVersionStrFull.zip"
WinRemoteFolder="yorigram"
Win64DeployPath="$BackupPath/$AppVersionStrMajor/$AppVersionStrFull/tx64"
Win64UpdateFile="tx64upd$AppVersion"
Win64SetupFile="yorigram-setup-x64.$AppVersionStrFull.exe"
...
WinArmSetupFile="yorigram-setup-arm64.$AppVersionStrFull.exe"
...
LinuxSetupFile="yorigram-setup.$AppVersionStrFull.tar.xz"
...
if [ "$DeployWin" == "1" ]; then
  Files+=("yorigram/$WinUpdateFile" "yorigram/$WinPortableFile")
  if [ "$AlphaVersion" == "0" ]; then
    Files+=("yorigram/$WinSetupFile")
  fi
fi
if [ "$DeployWin64" == "1" ]; then

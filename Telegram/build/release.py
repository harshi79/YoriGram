...
files.append({
  'local': 'yorigram-setup.' + version_full + '.exe',
  'remote': 'yorigram-setup.' + version_full + '.exe',
  'backup_folder': 'yorigram',
...
files.append({
  'local': 'yorigram-setup-x64.' + version_full + '.exe',
  'remote': 'yorigram-setup-x64.' + version_full + '.exe',
  'backup_folder': 'tx64',
  'mime': 'application/octet-stream',
...
files.append({
  'local': 'yorigram-setup-arm64.' + version_full + '.exe',
  'remote': 'yorigram-setup-arm64.' + version_full + '.exe',
...
files.append({
  'local': 'yorigram-setup.' + version_full + '.dmg',
  'remote': 'yorigram-setup.' + version_full + '.dmg',
  'backup_folder': 'tmac',
  'mime': 'application/octet-stream',
  'label': 'macOS 10.13+: Installer',
})
files.append({
  'local': 'yorigram-setup.' + version_full + '.tar.xz',
  'remote': 'yorigram-setup.' + version_full + '.tar.xz',
